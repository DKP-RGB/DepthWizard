...
addDecoder([void 0, 1], () => import("./raw-464WLDHJ.js").then((m) => m.default));
addDecoder(5, () => import("./lzw-QNSJIEZG.js").then((m) => m.default));
addDecoder(6, () => {
  throw new Error("old style JPEG compression is not supported.");
});
addDecoder(7, () => import("./jpeg-I7GRPC3Y.js").then((m) => m.default));
addDecoder([8, 32946], () => import("./deflate-2XZPZ3TI.js").then((m) => m.default));
addDecoder(32773, () => import("./packbits-FVCTJH5M.js").then((m) => m.default));
addDecoder(
  34887,
  () => import("./lerc-A44UEJUW.js").then(async (m) => {
    await m.zstd.init();
    return m;
  }).then((m) => m.default)
);
addDecoder(50001, () => import("./webimage-PBJJB7BF.js").then((m) => m.default));
  ...
  constructor(size = defaultPoolSize, createWorker) {
    ...
    if (size) {
      this._awaitingDecoder = createWorker ? Promise.resolve(createWorker) : new Promise((resolve) => {
        import("./decoder-4UI2WWYM.js").then((module) => {
