...
addDecoder([void 0, 1], () => import("./raw-ITD7FDMJ.js").then((m) => m.default));
addDecoder(5, () => import("./lzw-Z3D4ZHMD.js").then((m) => m.default));
addDecoder(6, () => {
  throw new Error("old style JPEG compression is not supported.");
});
addDecoder(7, () => import("./jpeg-UF4XQ4OL.js").then((m) => m.default));
addDecoder([8, 32946], () => import("./deflate-WJG66J24.js").then((m) => m.default));
addDecoder(32773, () => import("./packbits-RGIFIYW4.js").then((m) => m.default));
addDecoder(
  34887,
  () => import("./lerc-CG56CHJC.js").then(async (m) => {
    await m.zstd.init();
    return m;
  }).then((m) => m.default)
);
addDecoder(50001, () => import("./webimage-BUIBZYVE.js").then((m) => m.default));
  ...
  constructor(size = defaultPoolSize, createWorker) {
    ...
    if (size) {
      this._awaitingDecoder = createWorker ? Promise.resolve(createWorker) : new Promise((resolve) => {
        import("./decoder-ZBVQHGEK.js").then((module) => {
